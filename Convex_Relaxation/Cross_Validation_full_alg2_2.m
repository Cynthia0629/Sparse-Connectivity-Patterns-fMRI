clearvars -except net lambda_2 lambda_1 lambda_3 lambda scale st offs scale
...
% [B_gd{i},B_avg_gd{i},C_gd{i},W_ADOS_gd{i},W_SRS_gd{i},D_gd{i},lamb_gd{i}]  = gradient_descent_runner_multi_avg(corr_train{i},B_init,B_avg_init,C_init,W_init,D_init,Y_ADOS_train{i},Y_SRS_train{i},lamb_init,lambda,lambda_1,lambda_2,lambda_3,lr1);
