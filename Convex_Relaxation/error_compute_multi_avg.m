function err = error_compute_multi_avg(corr,B,B_avg,C,Y_ADOS,Y_SRS,W_ADOS,W_SRS,D,lamb,lambda,lambda_1,lambda_2,lambda_3)
...
for n = 1:size(corr,1)
    ...
    fit_err = fit_err + norm(X-B_avg,'fro').^2;
