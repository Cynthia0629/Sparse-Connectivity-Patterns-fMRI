function [B,B_avg,C,W,D,lamb] = gradient_descent_runner_avg(corr,B_init,B_avg_init,C_init,W_init,D_init,Y,lamb_init,lambda,lambda_1,lambda_2,lambda_3,lr1)
...
%     ylabel('Value of obejctive function')
    ...
    for i = 1:num_iter
        ...
        err_out= horzcat(err_out,error_compute_avg(corr,B_old,B_avg_old,C_old,Y,W_old,D_old,lamb_old,lambda,lambda_1,lambda_2,lambda_3));
