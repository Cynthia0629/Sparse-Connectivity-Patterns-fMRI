...
str = '/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/ADOS_CV';
load(strcat(str,'/workspace_',num2str(f),'_net_10_test',num2str(fold),'.mat'))
fprintf(str)
fprintf('\n')

for i =1:size(Y_obt_train,2)
...
str = '/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/SRS_Aut_CV';
load(strcat(str,'/workspace_',num2str(f),'_net_10_test',num2str(fold),'.mat'))
fprintf(str)
fprintf('\n')
...
str = '/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/SRS_Cont_CV';
load(strcat(str,'/workspace_',num2str(f),'_net_10_test',num2str(fold),'.mat'))
fprintf(str)
fprintf('\n')
