...
load('/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/Data_Simulation/Real_Data_SRSTotal_aut.mat')
...
str1 = strcat('/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/mod_2/SRS_Aut_runs/workspace_qp_s_2_',num2str(net),'_net.mat');
save(str1)