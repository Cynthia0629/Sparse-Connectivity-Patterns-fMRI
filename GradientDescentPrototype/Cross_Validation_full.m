...
st = '/home/niharika-shimona/Documents/Projects/Autism_Network/Results/Sparse connectivity patterns/10_fold_CV_new/Orthogonality/SRS_Aut_CV';
...
str2  = strcat(strr,'_testC',num2str(fold),'.mat');
save(str2)