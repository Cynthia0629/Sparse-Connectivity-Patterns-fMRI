...
fold =58;
% part =5; 
st = '/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/baseline/Outliers/ADOS_CV/Leave_One_Out';
...
%    parsave(sprintf('output%d.mat', i), B_gd{i},B_hat_gd{i},C_gd{i},W_gd{i}, ...
%    corr_train{i},corr_test{i},Y_train{i},Y_test{i}, ...
%    B_init,B_hat_init,C_init,W_init, ...
%    lambda,lambda_1,lambda_2,lambda_3,lr1);

parsave_non_avg(sprintf('output%d.mat', i), B_gd{i},C_gd{i},W_gd{i}, ...
   corr_train{i},corr_test{i},Y_train{i},Y_test{i}, ...
