...
fold =5;
 ...
 st = '/work-zfs/avenka14/Sparse-Connectivity-Patterns-fMRI/MultiModal_Modelling/Training_runs/Non_Avg/Binary/Thresh_0.2';
...
parfor i = 1:size(B_gd,2)
    ...
    C_gd_test{i}= quad_estimate_C_multimodal(B_gd{i},lambda_2,corr_test{i},Q_test{i});
    C_gd_train{i}= quad_estimate_C_multimodal(B_gd{i},lambda_2,corr_train{i},Q_train{i});
